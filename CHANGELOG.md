...
- Added `items fulltext <attachment-key>` to retrieve Zotero attachment full text, with raw stdout, `--json`, and `--output` file modes.
- Added structured `FULLTEXT_NOT_FOUND` handling for missing full-text resources.
...
[0.2.6]: https://github.com/cywwycedward/zotero-cli/compare/v0.2.5...v0.2.6
[0.2.3]: https://github.com/cywwycedward/zotero-cli/compare/v0.2.2...v0.2.3
[0.2.4]: https://github.com/cywwycedward/zotero-cli/compare/v0.2.3...v0.2.4
